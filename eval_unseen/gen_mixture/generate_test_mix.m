function generate_test_mix( noise_ch, dB, test_list, TMP_STORE)
    ...
    for i=1:snr_num
        ...
        for j=1:noise_num
            ...
            while ischar(tline)
                [tmp_n  fs] = audioread(['..' filesep '..' filesep '..' filesep 'premix_data' filesep 'noise' filesep noise_name '.wav']);   
                tmp_n = tmp_n(:,1);
        
                %IEEE sentence
                [s  s_fs] = audioread(['..' filesep '..' filesep '..' filesep 'premix_data' filesep 'clean_speech' filesep tline]);
